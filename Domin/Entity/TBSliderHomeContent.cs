...
{
    public class TBSliderHomeContent
    {
        [Key]
        public int IdSliderHomeContent { get; set; }
        public string Photo { get; set; }
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData), ErrorMessageResourceName = "VlNekName")]
        ...
        [Required(ErrorMessageResourceType = typeof(Resource.ResourceData), ErrorMessageResourceName = "UrlYoutubeButton")]
        ...
        public string UrlYoutubeButton { get; set; }
