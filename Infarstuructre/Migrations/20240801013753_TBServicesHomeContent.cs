...
{
    /// <inheritdoc />
    public partial class TBServicesHomeContent : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TBServicesHomeContents",
                columns: table => new
                {
                    IdServicesHomeContent = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBServicesHomeContents", x => x.IdServicesHomeContent);
                });
        }
