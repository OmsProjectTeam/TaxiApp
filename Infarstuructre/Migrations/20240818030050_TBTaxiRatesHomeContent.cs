...
{
    /// <inheritdoc />
    public partial class TBTaxiRatesHomeContent : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                name: "TBTaxiRatesHomeContents",
                columns: table => new
                {
                    IdTaxiRatesHomeContent = table.Column<int>(type: "int", nullable: false)
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TBTaxiRatesHomeContents", x => x.IdTaxiRatesHomeContent);
                });
        }
